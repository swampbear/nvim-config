return {
    ...
    -- Mason LSP Config
    {
        ...
        config = function()
            require('mason-lspconfig').setup {
                ensure_installed = { 'lua_ls', 'rust_analyzer', 'ts_ls', 'eslint', 'html', 'tailwindcss', 'pyright', 'gopls', 'clangd' },
                handlers = {
    ...
    -- Mason Tool Installer
    {
        ...
        config = function()
            require('mason-tool-installer').setup {
                ensure_installed = { 'prettier', 'stylua', 'ruff', 'clang-format' },
            }
        end,
    },
    ...
    -- Completion
    {
        ...
        config = function()
            ...
            luasnip.filetype_extend('c', { 'raylib', 'c' })
